...
#if TARGET_OS_IPHONE
    [self evaluateJavaScript:methodWithParam completionHandler:^(id _Nullable succs, NSError * _Nullable error) {
    }];
#elif TARGET_OS_MAC
...
- (void)resizeDiv {
    ...
    [self evaluateJavaScript:js completionHandler:^(id _Nullable succ, NSError * _Nullable error) {
    }];
}
